...
docker build . -t coderdream/node-web-app
...
PS D:\04_GitHub\nodejs\temp\docker_web_app> docker build . -t coderdream/node-web-app
...
Step 2/7 : WORKDIR /usr/src/app
 ---> Running in c364c121af9f
Removing intermediate container c364c121af9f
 ---> e34f40b3d92f
Step 3/7 : COPY package*.json ./
 ---> 4b580bb8ed32
Step 4/7 : RUN npm install
 ---> Running in 1424987a1cda
npm WARN docker_web_app@1.0.0 No repository field.


Removing intermediate container 1424987a1cda
 ---> ac0eb70ac4bf
Step 5/7 : COPY . .
 ---> 17a03f57e8e2
Step 6/7 : EXPOSE 8080
 ---> Running in 99d015824761
Removing intermediate container 99d015824761
 ---> 004ed9c8e809
Step 7/7 : CMD [ "node", "server.js" ]
 ---> Running in 169460814d92
Removing intermediate container 169460814d92
 ---> 3e6fec42b147
Successfully built 3e6fec42b147
Successfully tagged coderdream/node-web-app:latest
SECURITY WARNING: You are building a Docker image from Windows against a non-Windows Docker host. All files and directories added to build context will have '-rwxr-xr-x' permissions. It is recommended to double check and reset permissions for sensitive files and directories.

Use 'docker scan' to run Snyk tests against images to find vulnerabilities and learn how to fix them
PS D:\04_GitHub\nodejs\temp\docker_web_app>
```
...
- [把一个 Node.js web 应用程序给 Docker 化](https://nodejs.org/zh-cn/docs/guides/nodejs-docker-webapp/https://nodejs.org/zh-cn/docs/guides/nodejs-docker-webapp/)
